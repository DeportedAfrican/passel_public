...
pins_channel = 739647882810097714/1082732155798573176

# TODO
# add any black listed channel IDs as a list separated by a comma (,)
# a good idea is to add admin channels to this
blacklisted_channels = [862124467316588544, 904211261636616262]
...
# client.run('MTA4MjcyNzMzMjQ0NTQyNTc4OA.G6yqk4.0anwK-tGjnnGT9XDRYbFNeOwLHeXf0Uf3m-1_Y')
...
client.run(os.environ.get('MTA4MjcyNzMzMjQ0NTQyNTc4OA.G6yqk4.0anwK-tGjnnGT9XDRYbFNeOwLHeXf0Uf3m-1_Y'))
